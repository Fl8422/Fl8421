...
ores = {
    ...
    'Moon': [
        {'name': 'Лунный гранит', 'weight': 45},
        {'name': 'Селенит', 'weight': 35},
        {'name': 'Криолит', 'weight': 25},
        {'name': 'Старый Лунный металл', 'weight': 15},
        {'name': 'Метеоритная руда', 'weight': 5}
    ],
    'Mars': [
        {'name': 'Марсианский базальт', 'weight': 40},
        {'name': 'Красный гранит', 'weight': 30},
        {'name': 'Фобийский металл', 'weight': 20},
        {'name': 'Валькирия руда', 'weight': 10},
        {'name': 'Космическая руда', 'weight': 5}
    ]
}
...
# 🧰 Кейсы: Добавляем список кейсов без смайликов с уникальными названиями для каждой планеты
cases = {
    'Earth': [
    ...
    'Moon': [
        {'name': 'Кейс 1', 'price': 5000, 'min_reward': 3000, 'max_reward': 7000},
        {'name': 'Кейс 2', 'price': 10000, 'min_reward': 6000, 'max_reward': 14000},
        {'name': 'Кейс 3', 'price': 20000, 'min_reward': 12000, 'max_reward': 28000},
        {'name': 'Кейс 4', 'price': 40000, 'min_reward': 24000, 'max_reward': 56000},
        {'name': 'Кейс 5', 'price': 80000, 'min_reward': 48000, 'max_reward': 112000},
        {'name': 'Кейс 6', 'price': 160000, 'min_reward': 96000, 'max_reward': 224000},
        {'name': 'Кейс 7', 'price': 320000, 'min_reward': 192000, 'max_reward': 448000},
        {'name': 'Кейс 8', 'price': 640000, 'min_reward': 384000, 'max_reward': 896000},
        {'name': 'Кейс 9', 'price': 1280000, 'min_reward': 768000, 'max_reward': 1792000},
        {'name': 'Кейс 10', 'price': 2560000, 'min_reward': 1536000, 'max_reward': 3584000}
    ],
    'Mars': [
        {'name': 'Кейс 1', 'price': 10000, 'min_reward': 7000, 'max_reward': 13000},
        {'name': 'Кейс 2', 'price': 20000, 'min_reward': 14000, 'max_reward': 26000},
        {'name': 'Кейс 3', 'price': 40000, 'min_reward': 28000, 'max_reward': 52000},
        {'name': 'Кейс 4', 'price': 80000, 'min_reward': 56000, 'max_reward': 104000},
        {'name': 'Кейс 5', 'price': 160000, 'min_reward': 112000, 'max_reward': 208000},
        {'name': 'Кейс 6', 'price': 320000, 'min_reward': 224000, 'max_reward': 416000},
        {'name': 'Кейс 7', 'price': 640000, 'min_reward': 448000, 'max_reward': 832000},
        {'name': 'Кейс 8', 'price': 1280000, 'min_reward': 896000, 'max_reward': 1664000},
        {'name': 'Кейс 9', 'price': 2560000, 'min_reward': 1792000, 'max_reward': 3328000},
        {'name': 'Кейс 10', 'price': 5120000, 'min_reward': 3584000, 'max_reward': 6656000}
    ]
}
...
gamepasses = {
    'double_luck': {
        'name': 'Удвоенная удача',
        'price': 500000,  # Цена
        'description': 'Двойная удача на добытые руды.',
        'effect': 'double_luck'
    },
    'ultra_luck': {
        'name': 'Ультра удача',
        'price': 900000,
        'description': 'Удача увеличена в 5 раз на руды.',
        'effect': 'ultra_luck'
    },
    'double_ore': {
        'name': 'Двойная руда',
        'price': 700000,
        'description': 'Двойная руда выпадает при добыче руды.',
        'effect': 'double_ore'
    },
    'instant_smelting': {
        'name': 'Моментальная переплавка',
        'price': 500000,
        'description': 'Моментальная переплавка без ожидания 3 секунд.',
...
clicker = {
    'cooldown': 2,  # секунды
    'reward': 1  # монеты за клик
}

# Майнеры с уникальными названиями
miners = {
    'Mars': [
        {'name': 'Марсианский Нож', 'price': 7500, 'reward': 300, 'interval': 36000},  # 10 часов
        {'name': 'Красный Клинок', 'price': 14000, 'reward': 600, 'interval': 36000},
        {'name': 'Фобийский Дробитель', 'price': 21000, 'reward': 900, 'interval': 36000},
        {'name': 'Валькирия Боевая', 'price': 28000, 'reward': 1200, 'interval': 36000},
        {'name': 'Космический Извилин', 'price': 35000, 'reward': 1500, 'interval': 36000}
    ]
}
    ...
    with user_data_lock:
        if user_id not in user_data:
            user_data[user_id] = {
                ...
                'gamepasses': {},  # Покупленные геймпассы
                'clicker_last_click': 0,  # Время последнего клика
                'clicker_balance': 0,  # Баланс кликера
                'miners': {}  # Покупленные майнеры
            }
    welcome_text = (
...
def show_main_menu(message):
    ...
    switch_planet_button = types.KeyboardButton('🔄 Переключиться на планету')
...
- Воспользуйтесь 🛒 Магазином для покупки новых кирок, рюкзаков, печей и шахт.
...
- Геймпассы предоставляют специальные бонусы, такие как удвоенная удача, ультра удача, двойная руда и моментальная переплавка.
- Геймпассы можно приобрести в специальном разделе веб-приложения.
- Геймпассы не сбрасываются при ребиртах и сохраняются в вашем профиле.

1️⃣5️⃣ *Что такое Кликер?*
- Кликер позволяет вам получать монеты при нажатии на кнопку.
- Каждые 2 секунды вы можете получить 1 монету, кликая на кнопку.

1️⃣6️⃣ *Что такое Майнеры?*
- Майнеры автоматически добавляют монеты в ваш баланс через определённые интервалы времени.
- Каждый майнер имеет уникальное название и стоимость.
- Количество майнеров влияет на скорость накопления монет.
...
✨ *Геймпассы:*
- **Удвоенная удача**: Двойная удача на добытые руды.
- **Ультра удача**: Удача увеличена в 5 раз на руды.
- **Двойная руда**: Двойная руда выпадает при добыче руды.
- **Моментальная переплавка**: Моментальная переплавка без ожидания 3 секунд.
...
def main_handler(message):
    ...
    if message.text == '⛏ Добывать руду':
        ...
        smelt_ore(message)
    elif message.text in ['Купить Марс', 'Купить Луну']:
        # Эти покупки обрабатываются через register_next_step_handler в buy_planets_menu
        # Ничего не делаем здесь, чтобы избежать попадания в общий обработчик
        pass
...
def handle_web_app_data(message):
    ...
    try:
        ...
        if action == 'purchase_gamepass':
            gamepass_key = data_json.get('gamepass_key')
            purchase_gamepass(user_id, gamepass_key, message)
        elif action == 'purchase_click':
            purchase_clicker(user_id, message)
        elif action == 'purchase_miner':
            miner_key = data_json.get('miner_key')
            purchase_miner(user_id, miner_key, message)
        elif action == 'clicker_action':
            clicker_action(user_id, message)
        else:
            bot.send_message(message.chat.id, "Неизвестное действие из Web App.")
    except Exception as e:
        bot.send_message(message.chat.id, f"Ошибка обработки данных из Web App: {e}")

# Функция покупки геймпасса
def purchase_gamepass(user_id, gamepass_key, message):
    with user_data_lock:
        if gamepass_key not in gamepasses:
            bot.send_message(message.chat.id, "Некорректный геймпасс.")
            return
        if gamepass_key in user_data[user_id]['gamepasses']:
            bot.send_message(message.chat.id, "Вы уже приобрели этот геймпасс.")
            return
        gamepass = gamepasses[gamepass_key]
        price = gamepass['price']
        if user_data[user_id]['balance'] < price:
            bot.send_message(message.chat.id, f"У вас недостаточно монет для покупки {gamepass['name']}. Нужно {price} монет.")
            return
        # Покупка геймпасса
        user_data[user_id]['balance'] -= price
        user_data[user_id]['gamepasses'][gamepass_key] = True
    bot.send_message(message.chat.id, f"Вы успешно приобрели геймпасс '{gamepass['name']}'.")

# Функция покупки кликера
def purchase_clicker(user_id, message):
    with user_data_lock:
        # Допустим, кликер активируется бесплатно или за определенную цену
        # Здесь можно добавить цену, если требуется
        if 'clicker_active' not in user_data[user_id]:
            user_data[user_id]['clicker_active'] = False

        if user_data[user_id]['clicker_active']:
            bot.send_message(message.chat.id, "Ваш кликер уже активен.")
            return

        # Активируем кликер
        user_data[user_id]['clicker_active'] = True
        user_data[user_id]['clicker_balance'] = 0
    bot.send_message(message.chat.id, "Кликер активирован! Нажимайте на кнопку на сайте для получения монет.")
    # Запуск потока для автоматического начисления монет каждые 2 секунды при кликах
    threading.Thread(target=clicker_task, args=(user_id,)).start()

def clicker_task(user_id):
    while True:
        with user_data_lock:
            if not user_data[user_id].get('clicker_active', False):
                break
            last_click = user_data[user_id].get('clicker_last_click', 0)
            current_time = time.time()
            if current_time - last_click >= clicker['cooldown']:
                # Проверяем, есть ли клики
                if user_data[user_id]['clicker_balance'] > 0:
                    user_data[user_id]['balance'] += clicker['reward'] * user_data[user_id]['multiplier']
                    user_data[user_id]['clicker_balance'] -= 1
                    try:
                        bot.send_message(user_id, f"Ваш кликер добавил {clicker['reward'] * user_data[user_id]['multiplier']} монет на ваш баланс.")
                    except Exception:
                        pass
        time.sleep(1)

# Функция покупки майнера
def purchase_miner(user_id, miner_name, message):
    with user_data_lock:
        # Найти майнера по имени
        miner = next((m for m in miners['Mars'] if m['name'] == miner_name), None)
        if not miner:
            bot.send_message(message.chat.id, "Некорректный майнер.")
            return
        price = miner['price']
        if user_data[user_id]['balance'] < price:
            bot.send_message(message.chat.id, f"У вас недостаточно монет для покупки майнера '{miner['name']}'. Нужно {price} монет.")
            return
        # Покупка майнера
        user_data[user_id]['balance'] -= price
        if miner['name'] not in user_data[user_id]['miners']:
            user_data[user_id]['miners'][miner['name']] = {'count': 1, 'next_reward_time': time.time() + miner['interval']}
        else:
            user_data[user_id]['miners'][miner['name']]['count'] += 1
            user_data[user_id]['miners'][miner['name']]['next_reward_time'] = time.time() + miner['interval']
    bot.send_message(message.chat.id, f"Вы успешно приобрели майнера '{miner['name']}'. Он будет добавлять {miner['reward']} монет каждые {miner['interval'] / 3600} часов.")
    # Запуск майнера в отдельном потоке
    threading.Thread(target=miner_task, args=(user_id, miner)).start()

# Задача майнера
def miner_task(user_id, miner):
    while True:
        with user_data_lock:
            miner_info = user_data[user_id]['miners'].get(miner['name'])
            if not miner_info:
                break  # Майнер был удалён
            current_time = time.time()
            if current_time >= miner_info['next_reward_time']:
                reward = miner['reward'] * user_data[user_id]['multiplier']
                user_data[user_id]['balance'] += reward
                miner_info['next_reward_time'] = current_time + miner['interval']
                try:
                    bot.send_message(user_id, f"Ваш майнер '{miner['name']}' добавил {reward} монет на ваш баланс.")
                except Exception:
                    pass
...
def mine_ore(message):
    ...
    with user_data_lock:
        ...
        # Проверка наличия геймпассов
        double_luck = user_data[user_id]['gamepasses'].get('double_luck', False)
        ultra_luck = user_data[user_id]['gamepasses'].get('ultra_luck', False)
        double_ore = user_data[user_id]['gamepasses'].get('double_ore', False)
    ...
    # Применение геймпасса двойной руды
    if double_ore:
        amount *= 2
...
def process_smelting_amount(message):
    ...
    with user_data_lock:
        ...
        # Проверка геймпасса моментальной переплавки
        instant_smelting = user_data[user_id]['gamepasses'].get('instant_smelting', False)
        smelt_time = 0 if instant_smelting else 3  # Если геймпасс активен, время переплавки 0
    ...
    if smelt_time > 0:
        ...
        bot.send_message(message.chat.id, f"Переплавка {amount} x {ore} на планете {current_planet} начата моментально.")
...
def shop_menu(message):
    ...
    buy_cases_button = types.KeyboardButton('Кейсы')
    buy_rebirth_button = types.KeyboardButton('Купить ребирт') if rebirth_available else None
    buy_planets_button = types.KeyboardButton('Купить планеты')
    back_button = types.KeyboardButton('⏪ Меню')
...
def buy_planet(message, planet_name, price):
    ...
    with user_data_lock:
        ...
        # Майнеры и кликер инициализируются при покупке на сайте
...
def confirm_rebirth_purchase(message, rebirth):
    ...
    if message.text.lower() == 'да':
        ...
        with user_data_lock:
            ...
            # Сброс всех данных, кроме rebirth_count, multiplier и gamepasses
            ...
            user_data[user_id]['clicker_last_click'] = 0
            user_data[user_id]['clicker_balance'] = 0
            user_data[user_id]['miners'] = {}
            # Геймпассы сохраняются
        bot.send_message(message.chat.id, f"Поздравляем! Вы успешно совершили ребирт '{rebirth['name']}'. Ваш множитель монет увеличен на ×1.")
    else:
...
def purchase_clicker(user_id, message):
    with user_data_lock:
        # Проверяем, активирован ли уже кликер
        if user_data[user_id].get('clicker_active', False):
            bot.send_message(message.chat.id, "Ваш кликер уже активен.")
            return
        # Активируем кликер
        user_data[user_id]['clicker_active'] = True
        user_data[user_id]['clicker_balance'] = 0
    bot.send_message(message.chat.id, "Кликер активирован! Нажимайте на кнопку на сайте для получения монет.")
    # Запуск потока для автоматического начисления монет при кликах
    threading.Thread(target=clicker_task, args=(user_id,)).start()

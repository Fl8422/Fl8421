...
# Список руд (30 типов) для каждой планеты
ores = {
    'Earth': [
        {'name': 'Железная руда', 'weight': 10},
        {'name': 'Медная руда', 'weight': 8},
        {'name': 'Золотая руда', 'weight': 6},
        {'name': 'Серебряная руда', 'weight': 5},
        {'name': 'Платиновая руда', 'weight': 3},
        {'name': 'Алмазная руда', 'weight': 2},
        {'name': 'Рубиновая руда', 'weight': 2},
        {'name': 'Изумрудная руда', 'weight': 2},
        {'name': 'Сапфировая руда', 'weight': 2},
        {'name': 'Титанитовая руда', 'weight': 1},
        {'name': 'Урановая руда', 'weight': 1},
        {'name': 'Палладиевая руда', 'weight': 1},
        {'name': 'Платина-иридиевая руда', 'weight': 1},
        {'name': 'Лазуритовая руда', 'weight': 1},
        {'name': 'Ониксовая руда', 'weight': 1},
        {'name': 'Циркониевая руда', 'weight': 1},
        {'name': 'Гематитовая руда', 'weight': 1},
        {'name': 'Марганцевая руда', 'weight': 1},
        {'name': 'Кобальтовая руда', 'weight': 1},
        {'name': 'Никелевая руда', 'weight': 1},
        {'name': 'Литиевая руда', 'weight': 1},
        {'name': 'Молибденовая руда', 'weight': 1},
        {'name': 'Вольфрамовая руда', 'weight': 1},
        {'name': 'Свинцовая руда', 'weight': 1},
        {'name': 'Стронциевая руда', 'weight': 1},
        {'name': 'Индийская руда', 'weight': 1},
        {'name': 'Теллуровая руда', 'weight': 1},
        {'name': 'Бисмутовая руда', 'weight': 1},
        {'name': 'Лантанидовая руда', 'weight': 1},
        {'name': 'Активная руда', 'weight': 1}
    ],
    'Moon': [
        {'name': 'Лунная железная руда', 'weight': 12},
        {'name': 'Лунная медная руда', 'weight': 10},
        {'name': 'Лунная золотая руда', 'weight': 7},
        {'name': 'Лунная серебряная руда', 'weight': 6},
        {'name': 'Лунная платиновая руда', 'weight': 4},
        {'name': 'Лунная алмазная руда', 'weight': 3},
        {'name': 'Лунная рубиновая руда', 'weight': 3},
        {'name': 'Лунная изумрудная руда', 'weight': 3},
        {'name': 'Лунная сапфировая руда', 'weight': 3},
        {'name': 'Лунная титанитовая руда', 'weight': 2},
        {'name': 'Лунная урановая руда', 'weight': 2},
        {'name': 'Лунная палладиевая руда', 'weight': 2},
        {'name': 'Лунная платина-иридиевая руда', 'weight': 2},
        {'name': 'Лунная лазуритовая руда', 'weight': 2},
        {'name': 'Лунная ониксовая руда', 'weight': 2},
        {'name': 'Лунная циркониевая руда', 'weight': 2},
        {'name': 'Лунная гематитовая руда', 'weight': 2},
        {'name': 'Лунная марганцевая руда', 'weight': 2},
        {'name': 'Лунная кобальтовая руда', 'weight': 2},
        {'name': 'Лунная никелевая руда', 'weight': 2},
        {'name': 'Лунная литиевая руда', 'weight': 2},
        {'name': 'Лунная молибденовая руда', 'weight': 2},
        {'name': 'Лунная вольфрамовая руда', 'weight': 2},
        {'name': 'Лунная свинцовая руда', 'weight': 2},
        {'name': 'Лунная стронциевая руда', 'weight': 2},
        {'name': 'Лунная индийская руда', 'weight': 2},
        {'name': 'Лунная теллуровая руда', 'weight': 2},
        {'name': 'Лунная бисмутовая руда', 'weight': 2},
        {'name': 'Лунная лантанидовая руда', 'weight': 2},
        {'name': 'Лунная активная руда', 'weight': 2}
    ],
    'Mars': [
        {'name': 'Марсианская железная руда', 'weight': 14},
        {'name': 'Марсианская медная руда', 'weight': 12},
        {'name': 'Марсианская золотая руда', 'weight': 9},
        {'name': 'Марсианская серебряная руда', 'weight': 8},
        {'name': 'Марсианская платиновая руда', 'weight': 5},
        {'name': 'Марсианская алмазная руда', 'weight': 4},
        {'name': 'Марсианская рубиновая руда', 'weight': 4},
        {'name': 'Марсианская изумрудная руда', 'weight': 4},
        {'name': 'Марсианская сапфировая руда', 'weight': 4},
        {'name': 'Марсианская титанитовая руда', 'weight': 3},
        {'name': 'Марсианская урановая руда', 'weight': 3},
        {'name': 'Марсианская палладиевая руда', 'weight': 3},
        {'name': 'Марсианская платина-иридиевая руда', 'weight': 3},
        {'name': 'Марсианская лазуритовая руда', 'weight': 3},
        {'name': 'Марсианская ониксовая руда', 'weight': 3},
        {'name': 'Марсианская циркониевая руда', 'weight': 3},
        {'name': 'Марсианская гематитовая руда', 'weight': 3},
        {'name': 'Марсианская марганцевая руда', 'weight': 3},
        {'name': 'Марсианская кобальтовая руда', 'weight': 3},
        {'name': 'Марсианская никелевая руда', 'weight': 3},
        {'name': 'Марсианская литиевая руда', 'weight': 3},
        {'name': 'Марсианская молибденовая руда', 'weight': 3},
        {'name': 'Марсианская вольфрамовая руда', 'weight': 3},
        {'name': 'Марсианская свинцовая руда', 'weight': 3},
        {'name': 'Марсианская стронциевая руда', 'weight': 3},
        {'name': 'Марсианская индийская руда', 'weight': 3},
        {'name': 'Марсианская теллуровая руда', 'weight': 3},
        {'name': 'Марсианская бисмутовая руда', 'weight': 3},
        {'name': 'Марсианская лантанидовая руда', 'weight': 3},
        {'name': 'Марсианская активная руда', 'weight': 3}
    ]
}

# Список кирок (10 уровней) для каждой планеты
pickaxes = {
    'Earth': [
        {'name': 'Кирка Начинающего', 'luck': 1},
        {'name': 'Кирка Усовершенствованная', 'luck': 2},
        {'name': 'Кирка Эксперта', 'luck': 3},
        {'name': 'Кирка Мастера', 'luck': 4},
        {'name': 'Кирка Легенды', 'luck': 5},
        {'name': 'Кирка Императора', 'luck': 6},
        {'name': 'Кирка Совершенства', 'luck': 7},
        {'name': 'Кирка Великого', 'luck': 8},
        {'name': 'Кирка Небес', 'luck': 9},
        {'name': 'Кирка Божественная', 'luck': 10}
    ],
    'Moon': [
        {'name': 'Лунная кирка Начинающего', 'luck': 1},
        {'name': 'Лунная кирка Усовершенствованная', 'luck': 2},
        {'name': 'Лунная кирка Эксперта', 'luck': 3},
        {'name': 'Лунная кирка Мастера', 'luck': 4},
        {'name': 'Лунная кирка Легенды', 'luck': 5},
        {'name': 'Лунная кирка Императора', 'luck': 6},
        {'name': 'Лунная кирка Совершенства', 'luck': 7},
        {'name': 'Лунная кирка Великого', 'luck': 8},
        {'name': 'Лунная кирка Небес', 'luck': 9},
        {'name': 'Лунная кирка Божественная', 'luck': 10}
    ],
    'Mars': [
        {'name': 'Марсианская кирка Начинающего', 'luck': 1},
        {'name': 'Марсианская кирка Усовершенствованная', 'luck': 2},
        {'name': 'Марсианская кирка Эксперта', 'luck': 3},
        {'name': 'Марсианская кирка Мастера', 'luck': 4},
        {'name': 'Марсианская кирка Легенды', 'luck': 5},
        {'name': 'Марсианская кирка Императора', 'luck': 6},
        {'name': 'Марсианская кирка Совершенства', 'luck': 7},
        {'name': 'Марсианская кирка Великого', 'luck': 8},
        {'name': 'Марсианская кирка Небес', 'luck': 9},
        {'name': 'Марсианская кирка Божественная', 'luck': 10}
    ]
}

# Список рюкзаков (10 уровней) для каждой планеты
backpacks = {
    'Earth': [
        {'name': 'Рюкзак Начинающего', 'capacity': 10},
    ...
    'Moon': [
        {'name': 'Лунный рюкзак Начинающего', 'capacity': 10},
        {'name': 'Лунный рюкзак Усовершенствованный', 'capacity': 20},
        {'name': 'Лунный рюкзак Эксперта', 'capacity': 30},
        {'name': 'Лунный рюкзак Мастера', 'capacity': 40},
        {'name': 'Лунный рюкзак Легенды', 'capacity': 50},
        {'name': 'Лунный рюкзак Императора', 'capacity': 60},
        {'name': 'Лунный рюкзак Совершенства', 'capacity': 70},
        {'name': 'Лунный рюкзак Великого', 'capacity': 80},
        {'name': 'Лунный рюкзак Небес', 'capacity': 90},
        {'name': 'Лунный рюкзак Божественный', 'capacity': 100}
    ],
    'Mars': [
        {'name': 'Марсианский рюкзак Начинающего', 'capacity': 10},
        {'name': 'Марсианский рюкзак Усовершенствованный', 'capacity': 20},
        {'name': 'Марсианский рюкзак Эксперта', 'capacity': 30},
        {'name': 'Марсианский рюкзак Мастера', 'capacity': 40},
        {'name': 'Марсианский рюкзак Легенды', 'capacity': 50},
        {'name': 'Марсианский рюкзак Императора', 'capacity': 60},
        {'name': 'Марсианский рюкзак Совершенства', 'capacity': 70},
        {'name': 'Марсианский рюкзак Великого', 'capacity': 80},
        {'name': 'Марсианский рюкзак Небес', 'capacity': 90},
        {'name': 'Марсианский рюкзак Божественный', 'capacity': 100}
    ]
}

# Список печей (10 уровней) для каждой планеты
furnaces = {
    'Earth': [
        {'name': 'Печь Начинающего', 'smelt_capacity': 20},
        {'name': 'Печь Усовершенствованная', 'smelt_capacity': 40},
        {'name': 'Печь Эксперта', 'smelt_capacity': 60},
        {'name': 'Печь Мастера', 'smelt_capacity': 80},
        {'name': 'Печь Легенды', 'smelt_capacity': 100},
        {'name': 'Печь Императора', 'smelt_capacity': 120},
        {'name': 'Печь Совершенства', 'smelt_capacity': 140},
        {'name': 'Печь Великого', 'smelt_capacity': 160},
        {'name': 'Печь Небес', 'smelt_capacity': 180},
        {'name': 'Печь Божественная', 'smelt_capacity': 200}
    ],
    'Moon': [
...
# Список шахт (30 типов) для каждой планеты
mines = {
    'Earth': [
        'Заброшенная шахта',
        'Небольшая шахта',
...
# Список ребиртов (10 уровней) с ценой, увеличивающейся на 500,000
rebirths = [
...
# Список геймпассов с обновлёнными ценами и названиями
game_passes = {
    'double_luck': {
        ...
        'image_url': 'https://www.flaticon.com/free-icon/clover_781512?term=luck&page=1&position=4&origin=search&related_id=781512'
    },
    'ultra_luck': {
        'name': 'Ультра удача на руды',
        'price': 2500000,
        'description': 'Увеличивает удачу в 5 раз при добыче руды с кирками и без на всех шахтах и планетах.',
        'image_url': 'https://www.flaticon.com/free-icon/leaf_2871138?term=luck&page=2&position=2&origin=search&related_id=2871138'
    },
    'double_ores': {
        'name': 'Удвоенная руда',
        'price': 1000000,
        'description': 'Удваивает количество добываемой руды на всех шахтах и планетах.',
        'image_url': 'https://www.flaticon.com/free-icon/ore_8235456?term=ores&related_id=8235456'
    },
    'instant_smelting': {
        'name': 'Моментальная переплавка',
        'price': 450000,
        'description': 'Позволяет переплавлять руду мгновенно без ожидания.',
        'image_url': 'https://www.flaticon.com/free-icon/gold-ingots_362944?term=ingot&related_id=362944'
    }
}
...
def finish_smelting(message, ore, amount, smelt_time):
    try:
        if 'instant_smelting' in user_data[message.from_user.id]['game_passes']:
...
def open_game_pass_shop(message):
    ...
    mini_app_url = 'https://Fl8421.github.io/site/'  # Замените на ваш URL
...
def handle_web_app_data(message):
    ...
    try:
        ...
        if pass_type in game_passes:
            ...
            # Для этого используем метод 'sendMessage' с inline клавиатурой или другие методы
